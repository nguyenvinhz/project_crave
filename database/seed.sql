...
INSERT INTO MonAn (MaMon, TenMon, MaDM, GiaBan, HinhAnh, MoTa) VALUES
('MA01', N'Cơm gà xối mỡ', 'DM01', 45000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789654803/2023_12_6_638374928096209198_com-ga-xoi-mo-bao-nhieu-calo.webp', N'Cơm gà giòn, nước mắm chua ngọt'),
('MA02', N'Trà sữa trân châu', 'DM02', 35000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789655114/cach-lam-tra-sua-chan-trau-thom-ngon-tai-nha.jpg', N'Trà sữa truyền thống'),
('MA03', N'Bánh flan', 'DM03', 15000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789655151/cach-lam-banh-flan-thumbnail.jpg', N'Bánh flan caramel'),
('MA04', N'Phở bò tái', 'DM01', 50000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652157/crave/MA04_pho_bo_tai.jpg', N'Phở bò truyền thống, nước dùng ninh xương 8 tiếng'),
('MA05', N'Bún chả Hà Nội', 'DM01', 48000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789657008/2024_1_12_638406880045931692_cach-lam-bun-cha-ha-noi-0.webp', N'Chả nướng than hoa ăn kèm bún và nước chấm'),
('MA06', N'Mì xào hải sản', 'DM01', 55000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789657194/OIP.webp', N'Mì xào giòn cùng tôm, mực, rau củ'),
('MA07', N'Cơm tấm sườn bì chả', 'DM01', 42000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789656913/com-tam-suon-bi-cha-chay-1_99356b3b594740f793b4d570925b0572.jpg', N'Cơm tấm sườn nướng, bì, chả trứng'),
('MA08', N'Bún bò Huế', 'DM01', 47000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789655329/nau-bun-bo-hue-chuan-vi-tai-nha-voi-cot-co-dac-quoc-viet-foods_59b7ba1543004e67967af718d8afc32b.webp', N'Đậm vị cay nồng đặc trưng xứ Huế'),
('MA09', N'Cà phê sữa đá', 'DM02', 25000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789657259/OIP.webp', N'Cà phê phin truyền thống pha sữa đặc'),
('MA10', N'Nước ép cam', 'DM02', 30000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652163/crave/MA10_nuoc_ep_cam.jpg', N'Cam tươi ép nguyên chất, không đường hóa học'),
('MA11', N'Sinh tố bơ', 'DM02', 32000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789657333/OIP.webp', N'Sinh tố bơ sáp béo ngậy'),
('MA12', N'Trà đào cam sả', 'DM02', 38000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652165/crave/MA12_tra_dao_cam_sa.jpg', N'Trà đào thơm mát kèm cam và sả'),
('MA13', N'Nước chanh muối', 'DM02', 20000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652166/crave/MA13_nuoc_chanh_muoi.jpg', N'Giải khát chua nhẹ, thanh lọc'),
('MA14', N'Chè khúc bạch', 'DM03', 25000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789655493/che-khuc-bach-003-20220606.jpg', N'Khúc bạch, hạnh nhân, nhãn nhục'),
('MA15', N'Kem dừa', 'DM03', 20000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652169/crave/MA15_kem_dua.jpg', N'Kem vị dừa mát lạnh phục vụ trong trái dừa'),
('MA16', N'Bánh su kem', 'DM03', 12000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652170/crave/MA16_banh_su_kem.jpg', N'Vỏ bánh giòn, nhân kem trứng béo mịn'),
('MA17', N'Khoai tây chiên', 'DM04', 28000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652171/crave/MA17_khoai_tay_chien.jpg', N'Khoai tây chiên giòn ăn kèm tương ớt/mayonnaise'),
('MA18', N'Gà rán giòn', 'DM04', 45000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652172/crave/MA18_ga_ran_gion.jpg', N'Gà rán tẩm bột giòn rụm, 2 miếng'),
('MA19', N'Xúc xích nướng', 'DM04', 20000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789657405/OIP.webp', N'Xúc xích nướng than, 3 cây'),
('MA20', N'Lẩu thái hải sản', 'DM05', 180000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789657457/202311280950003415.webp', N'Lẩu chua cay hải sản, phục vụ 2-3 người'),
('MA21', N'Nướng BBQ thập cẩm', 'DM05', 220000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789652174/crave/MA21_nuong_bbq_thap_cam.jpg', N'Set nướng thịt bò, heo, gà, hải sản'),
('MA22', N'Đậu hũ sốt cà', 'DM06', 30000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789657511/OIP.webp', N'Đậu hũ chiên sốt cà chua kiểu chay'),
('MA23', N'Rau củ xào chay', 'DM06', 28000, 'https://res.cloudinary.com/mkx3r87x/image/upload/v1789657565/OIP.webp', N'Rau củ theo mùa xào tỏi kiểu chay');
